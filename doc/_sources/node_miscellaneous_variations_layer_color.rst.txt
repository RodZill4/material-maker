Color Layer Variations node
~~~~~~~~~~~~~~~~~~~~~~~~~~~

The **Color Layer Variations** node can be used to layer several variations of its input.
...
.. image:: images/node_miscellaneous_variations_layer_color.png
	:align: center

Inputs
++++++

The **Color Layer Variations** node has a grayscale input whose variations will be generated
and stacked, and a mask input that is applied to each layer.

Outputs
+++++++

The **Color Layer Variations** node has a single grayscale output that shows the layered variations.

Parameters
++++++++++

The **Color Layer Variations** node accepts the following parameters:
...
To generate variations, the **Color Layer Variations** node sets different values of the variations
variable.
