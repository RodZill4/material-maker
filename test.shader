...
const float p_o5951_R = 0.300000000;
const float p_o5951_r = 0.150000000;
vec2 o5950_input_distance(vec3 p, float _seed_variation_) {
float o5951_0_1_sdf3d = sdTorus((p).yzx, vec2(p_o5951_R, p_o5951_r));

return vec2(o5951_0_1_sdf3d, 0.0);
}
...
vec2 GetDist(vec3 p) {
	...
	vec2 d = o5950_input_distance(p, _seed_variation_);
