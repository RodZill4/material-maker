...
const CONTRIBUTORS = [
	...
	{
		name = "Hugo Locurcio",
		contribution = "Lots of contributions, mostly related to rendering and user interface"
	},
	{
		name = "Kasper Arnklit Frandsen",
		contribution = "Several nodes (including Auto Tones, Mask to SDF and Normal Blend) and node updates, and very nice video tutorials"
	},
	{
		name = "Roujel Williams",
		contribution = "Curvature, Ambient Occlusion and Thickness maps generation"
	},
	{
		name = "Bonbonmiel",
		contribution = "Many user interface improvements (in Nodes popup, 3D preview...)"
	},
	...
	{
		name = "Paulo Falcao",
		contribution = "Preview for v4v4 input/outputs and lots of ideas/feedback for SDF nodes"
	},
	{
		name = "Jesse Dubay",
		contribution = "3D preview and user interface improvements, Colormap node"
	},
	...
	{
		name = "Maybe you?",
		contribution = "If I forgot anyone here, or if you wish to contribute to this project, please don't hesitate to join our Discord channel and/or contact me directly"
	},
]
