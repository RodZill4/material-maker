...
const CONTRIBUTORS = [
	...
	{ name="williamchange", contribution="Several nodes (including Seven/Sixteen Segment Display, Roman numerals, Japanese Glyphs and Triangle Voronoi) and node updates", url="https://github.com/RodZill4/material-maker/commits/master/?author=williamchange" },
	...
	{ name="Theaninova", contribution="Spiral Gradient node", url="https://github.com/RodZill4/material-maker/commits/master/?author=Theaninova" },
