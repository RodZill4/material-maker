...
const SETTING_SDF2D_SOLID_BACKGROUND := "ui_preview_sdf2d_solid_background"
...
func _on_ready() -> void:
	...
	material.set_shader_parameter("solid", %SolidBg.button_pressed)
...
static func get_shader_code(preview_code : String) -> String:
	...
	var solid_bg : bool = mm_globals.get_config(SETTING_SDF2D_SOLID_BACKGROUND)
	...
	preview_code = preview_code.replace("$(solid_bg)", str(solid_bg))
	return preview_code
...
func load_defaults() -> void:
	...
	%SolidBg.button_pressed = mm_globals.DEFAULT_CONFIG[SETTING_SDF2D_SOLID_BACKGROUND]
	_on_ready()
...
func _on_solid_bg_toggled(toggled_on : bool) -> void:
	material.set_shader_parameter("solid", toggled_on)
