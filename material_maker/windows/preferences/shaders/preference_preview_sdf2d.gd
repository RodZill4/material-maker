...
func load_defaults() -> void:
	%BgColor.color = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_background_color"]
	%FgColor1.color = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_foreground_color1"]
	%FgColor2.color = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_foreground_color2"]
	%BorderThickness.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_border_thickness"]
	%IsolineDensity.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_isoline_density"]
	%IsolineThickness.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_isoline_thickness"]
	%IsolineOpacity.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_isoline_opacity"]
	%IsolineSmoothness.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_isoline_smoothness"]
	%ShadowFac.value = mm_globals.DEFAULT_CONFIG["ui_preview_sdf2d_shadow_opacity"]
	_on_ready()
