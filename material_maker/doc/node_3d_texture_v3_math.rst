...
.. image:: images/node_3d_texture_math_vec3.png
	:align: center

Inputs
++++++

The **Vec3 Math** node accepts two 3D texture inputs. Those inputs are optional, and when
left unconnected, the corresponding parameter value is used

Outputs
+++++++

The **Vec3 Math** node generates a single 3D texture that contains the result
