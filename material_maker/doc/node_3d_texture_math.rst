...
.. image:: images/node_3d_texture_math.png
	:align: center

Inputs
++++++

The **Math** node accepts two grayscale 3D texture inputs. Those inputs are optional, and when
left unconnected, the corresponding parameter value is used

Outputs
+++++++

The **Math** node generates a single grayscale 3D texture that contains the result
