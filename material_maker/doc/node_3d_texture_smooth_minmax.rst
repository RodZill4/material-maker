...
.. image:: images/node_3d_texture_math_smooth_minmax.png
	:align: center

Inputs
++++++

The **Smooth MinMax** node accepts two grayscale 3D texture inputs. Those inputs are optional, and when
left unconnected, the corresponding parameter value is used.

Outputs
+++++++

The **Smooth MinMax** node generates a single grayscale 3D texture that contains the result
of the operation.
