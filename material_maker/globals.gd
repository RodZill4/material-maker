...
const DEFAULT_CONFIG : Dictionary = {
	...
	ui_preview_sdf2d_background_color = Color(0.51,0.55,0.62),
	ui_preview_sdf2d_foreground_color1 = Color(0.8,0.57,1.0),
	ui_preview_sdf2d_foreground_color2 = Color(0.53,0.84,1.0),
	ui_preview_sdf2d_border_thickness = 0.05,
	ui_preview_sdf2d_isoline_density = 0.5,
	ui_preview_sdf2d_isoline_thickness = 0.2,
	ui_preview_sdf2d_isoline_opacity = 1.0,
	ui_preview_sdf2d_isoline_smoothness = 0.1,
	ui_preview_sdf2d_shadow_opacity = 1.0,
