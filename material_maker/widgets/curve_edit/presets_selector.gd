...
var presets = [
	...
	[
		MP.new(0.0, 0.0, 0.0, 5.0),
		MP.new(0.15, 0.65, 2.45201, 2.45201),
		MP.new(0.5, 1.0, 0.0, 0.0),
		MP.new(0.85, 0.65, -2.45201, -2.45201),
		MP.new(1.0, 0.0, -5.0, 0.0)
	],
	[
		MP.new(0.0, 0.0, 0.0, 2.38507),
		MP.new(0.292893, 0.707107, 2.34362, 0.428147),
		MP.new(1.0, 1.0, 0.410866, 0.0)
	]
]
