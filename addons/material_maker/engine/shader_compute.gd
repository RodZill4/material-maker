...
func set_shader_from_shadercode(shader_code : MMGenBase.ShaderCode, is_32_bits : bool = false) -> bool:
	return await compute_shader.set_shader_from_shadercode(shader_code, is_32_bits)
